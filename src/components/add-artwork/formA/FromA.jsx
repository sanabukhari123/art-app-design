...
import { Form, Input, Button, Checkbox, Select,Upload, Tabs, Radio,Modal,message } from "antd";
  ...
  return (
    ...
    >
      <div className="inner-form">
        <Form.Item className="small-width"
          label="Artwork Title* "
          name="Artwork Title"
...
"
        ...
        <Form.Item className="id-name small-width"
          label="ID*"
          name="ID*"
...
"
      ...
      <Upload {...props}>
    <Button>
      <UploadOutlined />Upload image(s)
    </Button>
  </Upload>
  <span className="message-format">Accepted formats: .jpg, .png, .bitmap, .tiff</span>
  </Form.Item>
